...
public class CSVFileReader{
    ...
    /**
     * General constructor for the csvfilereader.
     */
    public CSVFileReader(String filename, boolean hasHeader){
	...
	/*
	 * Assumed there is not header so jmp right to constructing 
	 * the body.
	 */
	this.body = new String[rows][columns];
